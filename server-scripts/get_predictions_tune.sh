...
# Script to fetch outputs produced by cara/classification/tune_threshold.py
# Usage: ./get_predictions_tune.sh
...
REMOTE_OUTPUT_FILE="${REMOTE_OUTPUT_FILE:-tune_threshold_results.txt}"
