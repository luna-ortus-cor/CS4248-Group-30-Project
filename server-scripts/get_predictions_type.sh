...
# Script to fetch outputs produced by cara/type/get_type.py
# Usage: ./get_predictions_type.sh
...
REMOTE_OUTPUT_DIR="${REMOTE_OUTPUT_DIR:-cara/type}"
REMOTE_OUTPUT_FILE="${REMOTE_OUTPUT_FILE:-target_type_label1_qwen8b.jsonl}"
