...
# Script to fetch outputs produced by cara/ablation/roberta-clip-baseline.py
# Usage: ./get_predictions_robertaclip.sh
...
REMOTE_OUTPUT_FILE="${REMOTE_OUTPUT_FILE:-predictions_roberta_clip_baseline.jsonl}"
