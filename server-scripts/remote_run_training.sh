...
TARGET_SCRIPT="${TARGET_SCRIPT:-cara/sft/training.py}"
...
echo "Running training script: $TARGET_SCRIPT"
echo "Training args: $TRAINING_ARGS"

mkdir -p "outputs" "judge-qwen3-lora" "judge-qwen3-lora-gguf"

echo "Running training script: $PYBIN $TARGET_SCRIPT $TRAINING_ARGS $*"
