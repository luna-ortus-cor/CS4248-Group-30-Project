...
# Script to fetch outputs produced by hateful-captioning/hateful-captioning-vllm.py
# Usage: ./get_predictions_captioning.sh
...
REMOTE_OUTPUT_FILE="${REMOTE_OUTPUT_FILE:-hateful-captioning/captions_vllm_output1_8b.jsonl}"
REMOTE_DIR="~/$REMOTE_BASE_DIR"
REMOTE_FILE="$REMOTE_DIR/$REMOTE_OUTPUT_FILE"
LOCAL_BASE_DIR="$(cd "$(dirname "$0")" && pwd)/hateful-captioning"
